...
@REM Skip the example plugin. You will want to remove this when creating your own plugin.
GOTO EXAMPLEEND
...
@REM This is for skipping the example plugin. You will want to remove this when creating your own plugin.
:EXAMPLEEND
